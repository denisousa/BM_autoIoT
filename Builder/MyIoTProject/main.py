...
if __name__ == '__main__':
    ...
    # ContainerSocket manages web socket communication between client and server
    from sockets import ContainerSocket
    socketio.on_namespace(ContainerSocket(app, "/data_container"))



    # Automatically generates an API based on Container model
    from models import Container
    api.create_api(Container, methods=['GET', 'POST', 'DELETE'], primary_key='key')

    # Automatically generates an API based on ContainerMainSensor model
    from models import ContainerMainSensor
    api.create_api(ContainerMainSensor, methods=['GET', 'POST', 'DELETE']
                   )

    # Automatically generates an API based on ContainerMainSensorData model
    from models import ContainerMainSensorData
    api.create_api(ContainerMainSensorData, methods=['GET', 'POST', 'DELETE']
                  )
